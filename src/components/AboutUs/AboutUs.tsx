...
export const AboutUs = () => {
  ...
  return (
    <section className={style.container}>
      ...
      <p className={style.text}>W Herbacianym Zakątku znajdziesz tylko takie produkty, które bez wahania kupilibyśmy
        sobie i naszym rodzinom.
      ...
      <p className={style.text}>Do każdej osoby w naszym otoczeniu, a co za tym idzie, także do każdego klienta,
        wychodzimy z ogromnym
